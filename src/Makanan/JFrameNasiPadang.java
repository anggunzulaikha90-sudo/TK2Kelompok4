 ...
 * @author ANGGUN Z
 */
public class JFrameNasiPadang extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JFrameNasiPadang.class.getName());
    ...
    private void bSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSimpanActionPerformed
        // TODO add your handling code here:
        nasiPadang np = new nasiPadang();
        np.setNamaMakanan(tNama.getText());
        np.setHarga(tHarga.getText());
        np.setKategori(cKategori.getSelectedItem().toString());
        
        tHasil1.setText(np.getNamaMakanan());
        tHasil2.setText(np.getHarga());
        tHasil3.setText(np.getKategori());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new JFrameNasiPadang().setVisible(true));
    }
